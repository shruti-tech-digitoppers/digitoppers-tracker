...
import { Shield, Briefcase, UserCheck, Eye } from 'lucide-react';
  ...
  return (
    <div className="border-t border-white/10 pt-4 space-y-2">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        ...
        >
          <div className="font-heading font-bold text-[#51a8b1] flex items-center gap-1.5">
        ...
        >
          <div className="font-heading font-bold text-[#a8cf45] flex items-center gap-1.5">
        ...
        <button
          ...
          className="p-2.5 text-left rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#51a8b1]/50 transition cursor-pointer"
        >
          <div className="font-heading font-bold text-[#84ccd3] flex items-center gap-1.5">
        ...
        <button
          ...
          className="p-2.5 text-left rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#a8cf45]/50 transition cursor-pointer"
        >
          <div className="font-heading font-bold text-[#cbe475] flex items-center gap-1.5">
